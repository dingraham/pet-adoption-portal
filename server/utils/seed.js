...
export async function seedDatabase() {
  ...
  const pets = [
    ...
    },
    {
      ...
      color: 'White',
      description:
        'Mochi is a sweet and curious cat with adorable folded ears. She loves to perch on high places and watch the world go by. Very affectionate once she warms up to you.',
      personality: ['Curious', 'Affectionate', 'Quiet', 'Independent'],
    ...
    },
    {
      ...
      description:
        'Duke is a well-trained and confident dog who needs an experienced handler. He is incredibly loyal to his family but requires proper introductions to new people.',
      personality: ['Confident', 'Loyal', 'Protective', 'Intelligent'],
      medicalHistory: 'Vaccinated, neutered, hip dysplasia managed',
      specialNeeds: true,
      goodWith: [],
      goodForFirstTime: false,
      activityLevel: 'moderate',
      ...
      status: 'available',
      dateAdded: new Date('2024-02-14').toISOString(),
    },
    {
      id: '13',
      name: 'Cleo',
      ...
      color: 'Ruddy',
      description:
        'Cleo is an athletic and adventurous cat who loves to climb and explore. She needs lots of vertical space and interactive toys to keep her entertained.',
      personality: ['Athletic', 'Adventurous', 'Intelligent', 'Energetic'],
      medicalHistory: 'Vaccinated, spayed, healthy',
      specialNeeds: false,
      goodWith: ['pets'],
      goodForFirstTime: false,
      activityLevel: 'high',
      ...
      status: 'available',
      dateAdded: new Date('2024-02-13').toISOString(),
    },
    {
      id: '14',
      name: 'Biscuit',
      ...
      color: 'Red and White',
      description:
        'Biscuit is a charming and playful Corgi with endless energy. He loves herding games and is incredibly food motivated, making training a breeze.',
      personality: ['Playful', 'Smart', 'Stubborn', 'Affectionate'],
      medicalHistory: 'Vaccinated, neutered, healthy',
      specialNeeds: false,
      goodWith: ['kids', 'pets'],
      goodForFirstTime: true,
      ...
      status: 'available',
      dateAdded: new Date('2024-02-11').toISOString(),
    },
    {
      id: '15',
      name: 'Midnight',
      ...
      color: 'Black',
      description:
        'Midnight is a sleek senior cat who loves nothing more than a warm lap and gentle pets. He is very mellow and would be perfect for a quiet household.',
      personality: ['Mellow', 'Loving', 'Calm', 'Gentle'],
      medicalHistory: 'Vaccinated, neutered, dental cleaning needed',
      specialNeeds: true,
      goodWith: ['kids'],
      goodForFirstTime: true,
      activityLevel: 'low',
      ...
      status: 'available',
      dateAdded: new Date('2024-02-09').toISOString(),
    },
    {
      id: '16',
      name: 'Ziggy',
      ...
      color: 'Chocolate',
      description:
        'Ziggy is a sassy and spirited Dachshund who thinks she is much bigger than she is. She loves to burrow under blankets and will alert you to any visitors.',
      personality: ['Sassy', 'Bold', 'Loyal', 'Alert'],
      medicalHistory: 'Vaccinated, spayed, back issues managed with weight control',
      specialNeeds: true,
      goodWith: [],
      goodForFirstTime: false,
      activityLevel: 'moderate',
    ...
    },
    {
      ...
      color: 'Blue',
      description:
        'Jasper is a chunky and adorable kitten with a plush coat. He is playful but also loves his nap time. Gets along great with other cats.',
      personality: ['Playful', 'Easygoing', 'Cuddly', 'Social'],
      medicalHistory: 'Vaccinations current, neutered, microchipped',
      specialNeeds: false,
      goodWith: ['kids', 'pets'],
      goodForFirstTime: true,
      ...
      status: 'available',
      dateAdded: new Date('2024-02-16').toISOString(),
    },
    {
      id: '18',
      name: 'Scout',
      ...
      color: 'Blue Merle',
      description:
        'Scout is a stunning Aussie puppy with boundless energy and intelligence. He needs a very active family who can provide mental stimulation and physical exercise daily.',
      personality: ['Energetic', 'Intelligent', 'Eager', 'Athletic'],
      medicalHistory: 'Vaccinations in progress, neutered, healthy',
      specialNeeds: false,
      goodWith: ['kids', 'pets'],
      goodForFirstTime: false,
      activityLevel: 'high',
      ...
      status: 'available',
      dateAdded: new Date('2024-02-17').toISOString(),
    },
    {
      id: '19',
      name: 'Nala',
      ...
      color: 'Seal Bicolor',
      description:
        'Nala is a gorgeous Ragdoll who goes limp when you pick her up. She is extremely affectionate and follows her humans from room to room like a puppy.',
      personality: ['Affectionate', 'Docile', 'Sweet', 'Loyal'],
      medicalHistory: 'Vaccinated, spayed, requires regular grooming',
      specialNeeds: false,
      goodWith: ['kids', 'pets'],
      goodForFirstTime: true,
      activityLevel: 'low',
      ...
      status: 'available',
      dateAdded: new Date('2024-02-06').toISOString(),
    },
    {
      id: '20',
      name: 'Rusty',
      ...
      color: 'Mahogany Red',
      description:
        'Rusty is a beautiful Irish Setter with a flowing red coat. He is friendly, outgoing, and loves to run. Would thrive in a home with an active lifestyle.',
      personality: ['Friendly', 'Outgoing', 'Active', 'Happy'],
      medicalHistory: 'Vaccinated, neutered, healthy',
      specialNeeds: false,
      goodWith: ['kids', 'pets'],
      goodForFirstTime: true,
